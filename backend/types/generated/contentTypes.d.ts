...
export interface ApiCategoriaPrendaCategoriaPrenda
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorias_prendas';
  info: {
    displayName: 'categoria_prenda';
    pluralName: 'categorias-prendas';
    singularName: 'categoria-prenda';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categoria-prenda.categoria-prenda'
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    precio_base: Schema.Attribute.Decimal;
    prenda_pedidos: Schema.Attribute.Relation<
      'oneToMany',
      'api::prenda-pedido.prenda-pedido'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPedidoPedido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    numero_pedido: Schema.Attribute.Text & Schema.Attribute.Unique;
    observaciones: Schema.Attribute.Text;
    prenda: Schema.Attribute.Relation<
      'oneToMany',
      'api::prenda-pedido.prenda-pedido'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPrendaPedidoPrendaPedido
  extends Struct.CollectionTypeSchema {
  collectionName: 'prendas_pedidos';
  info: {
    displayName: 'prenda_pedido';
    pluralName: 'prendas-pedidos';
    singularName: 'prenda-pedido';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    cantidad: Schema.Attribute.Integer;
    categoria_prenda: Schema.Attribute.Relation<
      'manyToOne',
      'api::categoria-prenda.categoria-prenda'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiProductoInventraioProductoInventraio
  extends Struct.CollectionTypeSchema {
  collectionName: 'productos_inventraios';
  info: {
    displayName: 'producto_inventraio';
    pluralName: 'productos-inventraios';
    singularName: 'producto-inventraio';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::producto-inventraio.producto-inventraio'
    > &
      Schema.Attribute.Private;
...
export interface ApiServicioServicio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String;
    precio_adicional: Schema.Attribute.Decimal & Schema.Attribute.Required;
    prenda_pedidos: Schema.Attribute.Relation<
      'manyToMany',
      'api::prenda-pedido.prenda-pedido'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categoria-prenda.categoria-prenda': ApiCategoriaPrendaCategoriaPrenda;
      'api::inventario.inventario': ApiInventarioInventario;
      'api::pedido.pedido': ApiPedidoPedido;
      'api::prenda-pedido.prenda-pedido': ApiPrendaPedidoPrendaPedido;
      'api::producto-inventraio.producto-inventraio': ApiProductoInventraioProductoInventraio;
